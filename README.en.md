...
[한국어](README.md) | **영어** | [일본어](README.ja.md) | [중국어](README.zh-CN.md)
...
- **App UI language: Korean / English**
...
This README is available in **Korean, English, Japanese, and Chinese** using the links at the top of the page.

Dorong's in-app UI currently supports **Korean and English**. Right-click Dorong and choose either `한국어` or `English` near the bottom of the menu.
